      ...
      <AnimatePresence>
        {open && (
          <motion.ul
            ...
            className="absolute right-0 top-full mt-2 w-32 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-lg overflow-hidden z-50"
          >
            {OPTIONS.map((opt) => {
