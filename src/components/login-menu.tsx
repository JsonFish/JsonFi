...
function GoogleIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="size-5">
      <path
        fill="#4285F4"
        d="M21.6 12.23c0-.71-.06-1.38-.18-2.03H12v3.85h5.38a4.6 4.6 0 0 1-2 3.02v2.5h3.24c1.9-1.75 2.98-4.34 2.98-7.34Z"
      />
      <path
        fill="#34A853"
        d="M12 22c2.7 0 4.96-.9 6.62-2.43l-3.24-2.5c-.9.6-2.04.97-3.38.97-2.6 0-4.81-1.76-5.6-4.13H3.06v2.58A10 10 0 0 0 12 22Z"
      />
      <path
        fill="#FBBC05"
      ...
      <path
        fill="#EA4335"
        d="M12 5.96c1.43 0 2.72.5 3.73 1.46l2.8-2.8A9.58 9.58 0 0 0 12 2a10 10 0 0 0-8.94 5.51l3.34 2.58c.79-2.37 3-4.13 5.6-4.13Z"
      />
    </svg>
  );
}
